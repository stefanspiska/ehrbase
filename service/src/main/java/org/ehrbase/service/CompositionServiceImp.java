...
public class CompositionServiceImp extends BaseServiceImp implements CompositionService {
    ...
    public Optional<CompositionDto> retrieve(UUID ehrId, UUID compositionId, Integer version) {
        I_CompositionAccess compositionAccess;
        if (version == null) {
            var latestVersion = getLastVersionNumber(compositionId);
            compositionAccess = I_CompositionAccess.retrieveCompositionVersion(getDataAccess(), ehrId, compositionId, latestVersion);
        } else {
            compositionAccess = I_CompositionAccess.retrieveCompositionVersion(getDataAccess(), ehrId, compositionId, version);
        }
