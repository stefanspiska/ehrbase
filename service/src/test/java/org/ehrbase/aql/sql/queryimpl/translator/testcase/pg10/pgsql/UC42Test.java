...
public class UC42Test extends UC42 {
    ...
    public UC42Test(){
        ...
        this.expectedSqlExpression =
                "(select ARRAY.COLUMN as \"Diagnose\", ARRAY.COLUMN as \"MabuseComposition\", ARRAY.COLUMN as \"NewerComposition\" from \"ehr\".\"entry\" right outer join \"ehr\".\"composition\" as \"composition_join\" on (\"composition_join\".\"id\" = \"ehr\".\"entry\".\"composition_id\" and \"composition_join\".\"ehr_id\" = \"ehr\".\"entry\".\"ehr_id\") join \"ehr\".\"event_context\" on (\"ehr\".\"event_context\".\"composition_id\" = \"composition_join\".\"id\" and \"ehr\".\"event_context\".\"ehr_id\" = \"composition_join\".\"ehr_id\") join \"ehr\".\"party_identified\" as \"composer_ref\" on \"composition_join\".\"composer\" = \"composer_ref\".\"id\" left outer join lateral (select (select jsonb_extract_path_text(cast(\"ehr\".\"js_composition\"(\n" +
                        ...
                        ") as jsonb),'value') as varchar) > cast('2020-01-01' as varchar)) as \"COLUMN\") as \"ARRAY\" on ? where \"ehr\".\"entry\".\"template_id\" = ?) union (select ARRAY.COLUMN as \"Diagnose\", ARRAY.COLUMN as \"MabuseComposition\", ARRAY.COLUMN as \"NewerComposition\" from \"ehr\".\"entry\" right outer join \"ehr\".\"composition\" as \"composition_join\" on (\"composition_join\".\"id\" = \"ehr\".\"entry\".\"composition_id\" and \"composition_join\".\"ehr_id\" = \"ehr\".\"entry\".\"ehr_id\") join \"ehr\".\"event_context\" on (\"ehr\".\"event_context\".\"composition_id\" = \"composition_join\".\"id\" and \"ehr\".\"event_context\".\"ehr_id\" = \"composition_join\".\"ehr_id\") join \"ehr\".\"party_identified\" as \"composer_ref\" on \"composition_join\".\"composer\" = \"composer_ref\".\"id\" left outer join lateral (select (select jsonb_extract_path_text(cast(\"ehr\".\"js_composition\"(\n" +
                        "  cast(composition_join.id as uuid), \n" +
                        "  'local'\n" +
                        ") as jsonb),'uid','value') as \"Diagnose\" where cast(jsonb_extract_path_text(cast(\"ehr\".\"js_dv_coded_text_inner\"(\"ehr\".\"entry\".\"name\") as jsonb),'value') as varchar) = cast('Diagnose' as varchar)) as \"COLUMN\") as \"ARRAY\" on ? left outer join lateral (select (select jsonb_extract_path_text(cast(\"ehr\".\"js_composition\"(\n" +
                        "  cast(composition_join.id as uuid), \n" +
