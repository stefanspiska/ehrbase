...
public class UC12Test extends UC12 {
    ...
    public UC12Test(){
        ...
        this.expectedSqlExpression =
                "select distinct on (\"/ehr_id/value\") \"\".\"/ehr_id/value\" from (select \"ehr_join\".\"id\" as \"/ehr_id/value\" from \"ehr\".\"entry\" right outer join \"ehr\".\"composition\" as \"composition_join\" on (\"composition_join\".\"id\" = \"ehr\".\"entry\".\"composition_id\" and \"composition_join\".\"ehr_id\" = \"ehr\".\"entry\".\"ehr_id\") right outer join \"ehr\".\"ehr\" as \"ehr_join\" on \"ehr_join\".\"id\" = \"composition_join\".\"ehr_id\" join lateral (\n" +
