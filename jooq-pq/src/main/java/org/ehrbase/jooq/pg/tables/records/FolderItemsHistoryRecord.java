...
public class FolderItemsHistoryRecord extends UpdatableRecordImpl<FolderItemsHistoryRecord> implements Record5<UUID, UUID, UUID, Timestamp, java.util.AbstractMap.SimpleEntry<java.time.OffsetDateTime,
                                        java.time.OffsetDateTime>> {

    private static final long serialVersionUID = 875478272;
    ...
    @Override
    public FolderItemsHistoryRecord value5(java.util.AbstractMap.SimpleEntry<java.time.OffsetDateTime,
                                        java.time.OffsetDateTime> value) {
        setSysPeriod(value);
        return this;
    }
    ...
    @Override
    public FolderItemsHistoryRecord values(UUID value1, UUID value2, UUID value3, Timestamp value4, java.util.AbstractMap.SimpleEntry<java.time.OffsetDateTime,
                                        java.time.OffsetDateTime> value5) {
        value1(value1);
        value2(value2);
        value3(value3);
     ...
     */
    public FolderItemsHistoryRecord(UUID folderId, UUID objectRefId, UUID inContribution, Timestamp sysTransaction, java.util.AbstractMap.SimpleEntry<java.time.OffsetDateTime,
