...
public class AttestationRecord extends UpdatableRecordImpl<AttestationRecord> implements Record6<UUID, String, String, Boolean, UUID, UUID> {

    private static final long serialVersionUID = -249894275;
    ...
    @Override
    public AttestationRecord values(UUID value1, String value2, String value3, Boolean value4, UUID value5, UUID value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
