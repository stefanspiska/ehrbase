...
public class CompositionHistoryRecord extends TableRecordImpl<CompositionHistoryRecord> implements Record14<UUID, UUID, UUID, Boolean, Boolean, String, Integer, UUID, Timestamp, java.util.AbstractMap.SimpleEntry<java.time.OffsetDateTime,
                                        java.time.OffsetDateTime>, UUID, UUID, JSONB, JSONB> {

    private static final long serialVersionUID = -1233315598;
    ...
    @Override
    public CompositionHistoryRecord value10(java.util.AbstractMap.SimpleEntry<java.time.OffsetDateTime,
                                        java.time.OffsetDateTime> value) {
        setSysPeriod(value);
        return this;
    }
    ...
    @Override
    public CompositionHistoryRecord values(UUID value1, UUID value2, UUID value3, Boolean value4, Boolean value5, String value6, Integer value7, UUID value8, Timestamp value9, java.util.AbstractMap.SimpleEntry<java.time.OffsetDateTime,
     ...
     */
    public CompositionHistoryRecord(UUID id, UUID ehrId, UUID inContribution, Boolean active, Boolean isPersistent, String language, Integer territory, UUID composer, Timestamp sysTransaction, java.util.AbstractMap.SimpleEntry<java.time.OffsetDateTime,
