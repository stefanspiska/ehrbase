...
public class SessionLog extends TableImpl<SessionLogRecord> {
    ...
    private static final long serialVersionUID = -1688597178;
     ...
     */
    public final TableField<SessionLogRecord, UUID> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.UUID.nullable(false).defaultValue(org.jooq.impl.DSL.field("uuid_generate_v4()", org.jooq.impl.SQLDataType.UUID)), this, "");

    /**
     * The column <code>ehr.session_log.subject_id</code>.
     */
    public final TableField<SessionLogRecord, String> SUBJECT_ID = createField(DSL.name("subject_id"), org.jooq.impl.SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>ehr.session_log.node_id</code>.
     */
    public final TableField<SessionLogRecord, String> NODE_ID = createField(DSL.name("node_id"), org.jooq.impl.SQLDataType.CLOB, this, "");

    /**
     * The column <code>ehr.session_log.session_id</code>.
     */
    public final TableField<SessionLogRecord, String> SESSION_ID = createField(DSL.name("session_id"), org.jooq.impl.SQLDataType.CLOB, this, "");

    /**
     * The column <code>ehr.session_log.session_name</code>.
     */
    public final TableField<SessionLogRecord, String> SESSION_NAME = createField(DSL.name("session_name"), org.jooq.impl.SQLDataType.CLOB, this, "");

    /**
     * The column <code>ehr.session_log.session_time</code>.
     */
    public final TableField<SessionLogRecord, Timestamp> SESSION_TIME = createField(DSL.name("session_time"), org.jooq.impl.SQLDataType.TIMESTAMP, this, "");

    /**
     * The column <code>ehr.session_log.ip_address</code>.
     */
    public final TableField<SessionLogRecord, String> IP_ADDRESS = createField(DSL.name("ip_address"), org.jooq.impl.SQLDataType.CLOB, this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.SESSION_LOG_PKEY);
    }
