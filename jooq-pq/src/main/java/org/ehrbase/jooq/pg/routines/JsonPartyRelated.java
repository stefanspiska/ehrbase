...
public class JsonPartyRelated extends AbstractRoutine<JSON> {

    private static final long serialVersionUID = 1390216909;

    /**
     * The parameter <code>ehr.json_party_related.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>ehr.json_party_related.ref_type</code>.
     */
    ...
    /**
     * The parameter <code>ehr.json_party_related.objectid_type</code>.
     */
    public static final Parameter<PartyRefIdType> OBJECTID_TYPE = Internal.createParameter("objectid_type", org.jooq.impl.SQLDataType.VARCHAR.asEnumDataType(PartyRefIdType.class), false, false);

    /**
     * The parameter <code>ehr.json_party_related.relationship</code>.
     */
    public static final Parameter<DvCodedTextRecord> RELATIONSHIP = Internal.createParameter("relationship", DvCodedText.DV_CODED_TEXT.getDataType(), false, false);

    /**
     * Create a new routine call instance
     */
    public JsonPartyRelated() {
        super("json_party_related", Ehr.EHR, org.jooq.impl.SQLDataType.JSON);
    ...
    /**
     * Set the <code>objectid_type</code> parameter to the function to be used with a {@link org.jooq.Select} statement
     */
    ...
    /**
     * Set the <code>relationship</code> parameter IN value to the routine
     */
    ...
    /**
     * Set the <code>relationship</code> parameter to the function to be used with a {@link org.jooq.Select} statement
     */
    public void setRelationship(Field<DvCodedTextRecord> field) {
        setField(RELATIONSHIP, field);
    }
}
