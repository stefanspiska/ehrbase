...
public class JsContribution extends AbstractRoutine<JSON> {

    private static final long serialVersionUID = -197978014;

    /**
     * The parameter <code>ehr.js_contribution.RETURN_VALUE</code>.
     */
     ...
     */
    public JsContribution() {
        super("js_contribution", Ehr.EHR, org.jooq.impl.SQLDataType.JSON);
