...
public class EntryRecord extends UpdatableRecordImpl<EntryRecord> implements Record14<UUID, UUID, Integer, EntryType, String, UUID, String, DvCodedTextRecord, JSONB, Timestamp, java.util.AbstractMap.SimpleEntry<java.time.OffsetDateTime,
                                        java.time.OffsetDateTime>, String, DvCodedTextRecord, UUID> {

    private static final long serialVersionUID = 513223459;
    ...
    public java.util.AbstractMap.SimpleEntry<java.time.OffsetDateTime,
        ...
        return (java.util.AbstractMap.SimpleEntry<java.time.OffsetDateTime,
                                        java.time.OffsetDateTime>) get(10);
    }
    ...
    /**
     * Setter for <code>ehr.entry.ehr_id</code>.
     */
    ...
    /**
     * Getter for <code>ehr.entry.ehr_id</code>.
     */
    ...
    @Override
    public Row14<UUID, UUID, Integer, EntryType, String, UUID, String, DvCodedTextRecord, JSONB, Timestamp, java.util.AbstractMap.SimpleEntry<java.time.OffsetDateTime,
                                        java.time.OffsetDateTime>, String, DvCodedTextRecord, UUID> valuesRow() {
    ...
    public Field<java.util.AbstractMap.SimpleEntry<java.time.OffsetDateTime,
                                        java.time.OffsetDateTime>> field11() {
    ...
    @Override
    public java.util.AbstractMap.SimpleEntry<java.time.OffsetDateTime,
                                        java.time.OffsetDateTime> component11() {
        return getSysPeriod();
    }
    ...
    @Override
    public java.util.AbstractMap.SimpleEntry<java.time.OffsetDateTime,
                                        java.time.OffsetDateTime> value11() {
        return getSysPeriod();
    }
    ...
    @Override
    public EntryRecord value11(java.util.AbstractMap.SimpleEntry<java.time.OffsetDateTime,
                                        java.time.OffsetDateTime> value) {
        setSysPeriod(value);
        return this;
    }
    ...
    @Override
    public EntryRecord value14(UUID value) {
        setEhrId(value);
        return this;
    }

    @Override
    public EntryRecord values(UUID value1, UUID value2, Integer value3, EntryType value4, String value5, UUID value6, String value7, DvCodedTextRecord value8, JSONB value9, Timestamp value10, java.util.AbstractMap.SimpleEntry<java.time.OffsetDateTime,
                                        java.time.OffsetDateTime> value11, String value12, DvCodedTextRecord value13, UUID value14) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public EntryRecord(UUID id, UUID compositionId, Integer sequence, EntryType itemType, String templateId, UUID templateUuid, String archetypeId, DvCodedTextRecord category, JSONB entry, Timestamp sysTransaction, java.util.AbstractMap.SimpleEntry<java.time.OffsetDateTime,
                                        java.time.OffsetDateTime> sysPeriod, String rmVersion, DvCodedTextRecord name, UUID ehrId) {
        super(Entry.ENTRY);
