...
public class JsParty extends AbstractRoutine<JSON> {

    private static final long serialVersionUID = 903667388;

    /**
     * The parameter <code>ehr.js_party.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>ehr.js_party._1</code>.
     */
     ...
     */
    public JsParty() {
        super("js_party", Ehr.EHR, org.jooq.impl.SQLDataType.JSON);
