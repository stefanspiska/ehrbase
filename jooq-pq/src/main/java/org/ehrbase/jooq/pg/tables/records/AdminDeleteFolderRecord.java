...
public class AdminDeleteFolderRecord extends TableRecordImpl<AdminDeleteFolderRecord> implements Record3<UUID, UUID, UUID> {

    private static final long serialVersionUID = 1431699065;
