...
public class ParticipationRecord extends UpdatableRecordImpl<ParticipationRecord> implements Record11<UUID, UUID, UUID, DvCodedTextRecord, DvCodedTextRecord, Timestamp, String, Timestamp, java.util.AbstractMap.SimpleEntry<java.time.OffsetDateTime,
                                        java.time.OffsetDateTime>, Timestamp, String> {

    private static final long serialVersionUID = -1077514411;
    ...
    @Override
    public ParticipationRecord value9(java.util.AbstractMap.SimpleEntry<java.time.OffsetDateTime,
                                        java.time.OffsetDateTime> value) {
        setSysPeriod(value);
        return this;
    }
    ...
    @Override
    public ParticipationRecord values(UUID value1, UUID value2, UUID value3, DvCodedTextRecord value4, DvCodedTextRecord value5, Timestamp value6, String value7, Timestamp value8, java.util.AbstractMap.SimpleEntry<java.time.OffsetDateTime,
     ...
     */
    public ParticipationRecord(UUID id, UUID eventContext, UUID performer, DvCodedTextRecord function, DvCodedTextRecord mode, Timestamp timeLower, String timeLowerTz, Timestamp sysTransaction, java.util.AbstractMap.SimpleEntry<java.time.OffsetDateTime,
