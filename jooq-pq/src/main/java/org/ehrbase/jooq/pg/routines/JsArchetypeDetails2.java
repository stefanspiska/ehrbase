...
public class JsArchetypeDetails2 extends AbstractRoutine<JSONB> {
    ...
    private static final long serialVersionUID = 1947220082;
     ...
     */
    public static final Parameter<String> RM_VERSION = Internal.createParameter("rm_version", org.jooq.impl.SQLDataType.CLOB, false, false);
    ...
    /**
     * Set the <code>rm_version</code> parameter to the function to be used with a {@link org.jooq.Select} statement
     */
