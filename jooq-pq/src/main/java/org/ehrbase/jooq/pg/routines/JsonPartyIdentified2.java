...
public class JsonPartyIdentified2 extends AbstractRoutine<JSON> {

    private static final long serialVersionUID = 1565531381;
    ...
    /**
     * The parameter <code>ehr.json_party_identified.objectid_type</code>.
     */
