...
public class PartyIdentifiedRecord extends UpdatableRecordImpl<PartyIdentifiedRecord> implements Record9<UUID, String, String, String, String, String, PartyType, DvCodedTextRecord, PartyRefIdType> {

    private static final long serialVersionUID = 676792183;
    ...
    @Override
    public Row9<UUID, String, String, String, String, String, PartyType, DvCodedTextRecord, PartyRefIdType> valuesRow() {
    ...
    @Override
    public PartyIdentifiedRecord values(UUID value1, String value2, String value3, String value4, String value5, String value6, PartyType value7, DvCodedTextRecord value8, PartyRefIdType value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public PartyIdentifiedRecord(UUID id, String name, String partyRefValue, String partyRefScheme, String partyRefNamespace, String partyRefType, PartyType partyType, DvCodedTextRecord relationship, PartyRefIdType objectIdType) {
        super(PartyIdentified.PARTY_IDENTIFIED);

        set(0, id);
        set(1, name);
        set(2, partyRefValue);
        set(3, partyRefScheme);
        set(4, partyRefNamespace);
        set(5, partyRefType);
        set(6, partyType);
        set(7, relationship);
        set(8, objectIdType);
