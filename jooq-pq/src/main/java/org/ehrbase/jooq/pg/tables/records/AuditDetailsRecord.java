...
public class AuditDetailsRecord extends UpdatableRecordImpl<AuditDetailsRecord> implements Record7<UUID, UUID, UUID, Timestamp, String, ContributionChangeType, String> {

    private static final long serialVersionUID = -1638741775;
    ...
    @Override
    public AuditDetailsRecord values(UUID value1, UUID value2, UUID value3, Timestamp value4, String value5, ContributionChangeType value6, String value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AuditDetailsRecord(UUID id, UUID systemId, UUID committer, Timestamp timeCommitted, String timeCommittedTzid, ContributionChangeType changeType, String description) {
        super(AuditDetails.AUDIT_DETAILS);
