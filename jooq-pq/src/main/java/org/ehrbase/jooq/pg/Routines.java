...
import org.ehrbase.jooq.pg.routines.CastAsInterval;
...
public class Routines {
     ...
     */
    public static JSONB aqlNodeNamePredicate(Configuration configuration, JSONB entry, String nameValuePredicate, String jsonbPath) {
     ...
     * Get <code>ehr.aql_node_name_predicate</code> as a field.
     */
    public static Field<JSONB> aqlNodeNamePredicate(Field<JSONB> entry, Field<String> nameValuePredicate, Field<String> jsonbPath) {
        AqlNodeNamePredicate f = new AqlNodeNamePredicate();
        f.setEntry(entry);
        f.setNameValuePredicate(nameValuePredicate);
        f.setJsonbPath(jsonbPath);
    ...
    /**
     * Call <code>ehr.cast_as_interval</code>
     */
    public static YearToSecond castAsInterval(Configuration configuration, String __1) {
        CastAsInterval f = new CastAsInterval();
        f.set__1(__1);
    ...
    /**
     * Get <code>ehr.cast_as_interval</code> as a field.
     */
    public static Field<YearToSecond> castAsInterval(String __1) {
        CastAsInterval f = new CastAsInterval();
        f.set__1(__1);
     ...
     * Get <code>ehr.cast_as_interval</code> as a field.
     */
    public static Field<YearToSecond> castAsInterval(Field<String> __1) {
        CastAsInterval f = new CastAsInterval();
        f.set__1(__1);
     ...
     * Call <code>ehr.js_archetype_details</code>
     */
    public static JSONB jsArchetypeDetails2(Configuration configuration, String archetypeNodeId, String templateId, String rmVersion) {
     ...
     * Get <code>ehr.js_archetype_details</code> as a field.
     */
    public static Field<JSONB> jsArchetypeDetails2(Field<String> archetypeNodeId, Field<String> templateId, Field<String> rmVersion) {
        JsArchetypeDetails2 f = new JsArchetypeDetails2();
        f.setArchetypeNodeId(archetypeNodeId);
        f.setTemplateId(templateId);
        f.setRmVersion(rmVersion);
     ...
     */
    public static JSON jsCanonicalDvQuantity(Configuration configuration, Double magnitude, String units, Integer _Precision, Boolean accuracyPercent) {
     ...
     */
    public static Field<JSON> jsCanonicalDvQuantity(Double magnitude, String units, Integer _Precision, Boolean accuracyPercent) {
        JsCanonicalDvQuantity f = new JsCanonicalDvQuantity();
        f.setMagnitude(magnitude);
        f.setUnits(units);
        f.set_Precision(_Precision);
     ...
     * Get <code>ehr.js_canonical_dv_quantity</code> as a field.
     */
    public static Field<JSON> jsCanonicalDvQuantity(Field<Double> magnitude, Field<String> units, Field<Integer> _Precision, Field<Boolean> accuracyPercent) {
        JsCanonicalDvQuantity f = new JsCanonicalDvQuantity();
        f.setMagnitude(magnitude);
        f.setUnits(units);
        f.set_Precision(_Precision);
     ...
     */
    public static JSON jsCanonicalObjectId(Configuration configuration, PartyRefIdType objectidType, String scheme, String idValue) {
     ...
     * Get <code>ehr.js_canonical_object_id</code> as a field.
     */
    public static Field<JSON> jsCanonicalObjectId(Field<PartyRefIdType> objectidType, Field<String> scheme, Field<String> idValue) {
        JsCanonicalObjectId f = new JsCanonicalObjectId();
        f.setObjectidType(objectidType);
        f.setScheme(scheme);
        f.setIdValue(idValue);
     ...
     */
    public static JSON jsCanonicalPartyRef(Configuration configuration, String namespace, String type, String scheme, String id) {
     ...
     * Get <code>ehr.js_canonical_party_ref</code> as a field.
     */
    public static Field<JSON> jsCanonicalPartyRef(Field<String> namespace, Field<String> type, Field<String> scheme, Field<String> id) {
        JsCanonicalPartyRef f = new JsCanonicalPartyRef();
        f.setNamespace(namespace);
        f.setType(type);
        f.setScheme(scheme);
     ...
     * Call <code>ehr.js_dv_coded_text_inner</code>
     */
    public static JSON jsDvCodedTextInner2(Configuration configuration, String value, String terminologyId, String codeString) {
     ...
     * Get <code>ehr.js_dv_coded_text_inner</code> as a field.
     */
    public static Field<JSON> jsDvCodedTextInner2(Field<String> value, Field<String> terminologyId, Field<String> codeString) {
        JsDvCodedTextInner2 f = new JsDvCodedTextInner2();
        f.setValue(value);
        f.setTerminologyId(terminologyId);
        f.setCodeString(codeString);
     ...
     */
    public static JSON jsonPartyIdentified1(Configuration configuration, String name, UUID refid, String namespace, String refType, String scheme, String idValue) {
     ...
     */
    public static Field<JSON> jsonPartyIdentified1(String name, UUID refid, String namespace, String refType, String scheme, String idValue) {
        JsonPartyIdentified1 f = new JsonPartyIdentified1();
        f.setName_(name);
        f.setRefid(refid);
        f.setNamespace(namespace);
     ...
     * Get <code>ehr.json_party_identified</code> as a field.
     */
    public static Field<JSON> jsonPartyIdentified1(Field<String> name, Field<UUID> refid, Field<String> namespace, Field<String> refType, Field<String> scheme, Field<String> idValue) {
        JsonPartyIdentified1 f = new JsonPartyIdentified1();
        f.setName_(name);
        f.setRefid(refid);
        f.setNamespace(namespace);
     ...
     * Call <code>ehr.json_party_identified</code>
     */
    public static JSON jsonPartyIdentified2(Configuration configuration, String name, UUID refid, String namespace, String refType, String scheme, String idValue, PartyRefIdType objectidType) {
     ...
     * Get <code>ehr.json_party_identified</code> as a field.
     */
    public static Field<JSON> jsonPartyIdentified2(String name, UUID refid, String namespace, String refType, String scheme, String idValue, PartyRefIdType objectidType) {
        JsonPartyIdentified2 f = new JsonPartyIdentified2();
        f.setName_(name);
        f.setRefid(refid);
        f.setNamespace(namespace);
     ...
     * Get <code>ehr.json_party_identified</code> as a field.
     */
    public static Field<JSON> jsonPartyIdentified2(Field<String> name, Field<UUID> refid, Field<String> namespace, Field<String> refType, Field<String> scheme, Field<String> idValue, Field<PartyRefIdType> objectidType) {
        JsonPartyIdentified2 f = new JsonPartyIdentified2();
        f.setName_(name);
        f.setRefid(refid);
        f.setNamespace(namespace);
     ...
     */
    public static JSON jsonPartyRelated(Configuration configuration, String name, UUID refid, String namespace, String refType, String scheme, String idValue, PartyRefIdType objectidType, DvCodedTextRecord relationship) {
     ...
     */
    public static Field<JSON> jsonPartyRelated(String name, UUID refid, String namespace, String refType, String scheme, String idValue, PartyRefIdType objectidType, DvCodedTextRecord relationship) {
        JsonPartyRelated f = new JsonPartyRelated();
        f.setName_(name);
        f.setRefid(refid);
        f.setNamespace(namespace);
     ...
     * Get <code>ehr.json_party_related</code> as a field.
     */
    public static Field<JSON> jsonPartyRelated(Field<String> name, Field<UUID> refid, Field<String> namespace, Field<String> refType, Field<String> scheme, Field<String> idValue, Field<PartyRefIdType> objectidType, Field<DvCodedTextRecord> relationship) {
        JsonPartyRelated f = new JsonPartyRelated();
        f.setName_(name);
        f.setRefid(refid);
        f.setNamespace(namespace);
     ...
     */
    public static JSON jsonPartySelf(Configuration configuration, UUID refid, String namespace, String refType, String scheme, String idValue, PartyRefIdType objectidType) {
     ...
     */
    public static Field<JSON> jsonPartySelf(UUID refid, String namespace, String refType, String scheme, String idValue, PartyRefIdType objectidType) {
        JsonPartySelf f = new JsonPartySelf();
        f.setRefid(refid);
        f.setNamespace(namespace);
        f.setRefType(refType);
     ...
     * Get <code>ehr.json_party_self</code> as a field.
     */
    public static Field<JSON> jsonPartySelf(Field<UUID> refid, Field<String> namespace, Field<String> refType, Field<String> scheme, Field<String> idValue, Field<PartyRefIdType> objectidType) {
        JsonPartySelf f = new JsonPartySelf();
        f.setRefid(refid);
        f.setNamespace(namespace);
        f.setRefType(refType);
     ...
     */
    public static JSONB partyRef(Configuration configuration, String namespace, String refType, String scheme, String idValue, PartyRefIdType objectidType) {
     ...
     */
    public static Field<JSONB> partyRef(String namespace, String refType, String scheme, String idValue, PartyRefIdType objectidType) {
        PartyRef f = new PartyRef();
        f.setNamespace(namespace);
        f.setRefType(refType);
        f.setScheme(scheme);
     ...
     * Get <code>ehr.party_ref</code> as a field.
     */
    public static Field<JSONB> partyRef(Field<String> namespace, Field<String> refType, Field<String> scheme, Field<String> idValue, Field<PartyRefIdType> objectidType) {
        PartyRef f = new PartyRef();
        f.setNamespace(namespace);
        f.setRefType(refType);
        f.setScheme(scheme);
     ...
     */
    public static Result<AdminDeleteAttestationRecord> adminDeleteAttestation(Configuration configuration, UUID attestRefInput) {
     ...
     */
    public static Result<AdminDeleteCompositionRecord> adminDeleteComposition(Configuration configuration, UUID compoIdInput) {
     ...
     */
    public static Result<AdminDeleteCompositionHistoryRecord> adminDeleteCompositionHistory(Configuration configuration, UUID compoInput) {
     ...
     */
    public static Result<AdminDeleteContributionRecord> adminDeleteContribution(Configuration configuration, UUID contribIdInput) {
     ...
     */
    public static Result<AdminDeleteEhrHistoryRecord> adminDeleteEhrHistory(Configuration configuration, UUID ehrIdInput) {
     ...
     */
    public static Result<AdminDeleteEventContextForCompoRecord> adminDeleteEventContextForCompo(Configuration configuration, UUID compoIdInput) {
     ...
     */
    public static Result<AdminDeleteFolderHistoryRecord> adminDeleteFolderHistory(Configuration configuration, UUID folderIdInput) {
     ...
     */
    public static Result<AdminDeleteFolderObjRefHistoryRecord> adminDeleteFolderObjRefHistory(Configuration configuration, UUID contributionIdInput) {
     ...
     */
    public static Result<AdminDeleteStatusHistoryRecord> adminDeleteStatusHistory(Configuration configuration, UUID statusIdInput) {
     ...
     */
    public static Result<AdminGetLinkedCompositionsRecord> adminGetLinkedCompositions(Configuration configuration, UUID ehrIdInput) {
     ...
     */
    public static Result<AdminGetLinkedCompositionsForContribRecord> adminGetLinkedCompositionsForContrib(Configuration configuration, UUID contribIdInput) {
     ...
     * Get <code>ehr.admin_get_linked_compositions_for_contrib</code> as a table.
     */
    public static AdminGetLinkedCompositionsForContrib adminGetLinkedCompositionsForContrib(Field<UUID> contribIdInput) {
        return AdminGetLinkedCompositionsForContrib.ADMIN_GET_LINKED_COMPOSITIONS_FOR_CONTRIB.call(contribIdInput);
    }
     ...
     */
    public static Result<AdminGetLinkedContributionsRecord> adminGetLinkedContributions(Configuration configuration, UUID ehrIdInput) {
     ...
     */
    public static Result<AdminGetLinkedStatusForContribRecord> adminGetLinkedStatusForContrib(Configuration configuration, UUID contribIdInput) {
     ...
     */
    public static Result<AdminGetTemplateUsageRecord> adminGetTemplateUsage(Configuration configuration, String targetId) {
     ...
     */
    public static Result<PartyUsageIdentificationRecord> partyUsageIdentification(Configuration configuration, UUID partyUuid) {
