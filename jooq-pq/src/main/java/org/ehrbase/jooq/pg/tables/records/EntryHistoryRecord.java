...
public class EntryHistoryRecord extends TableRecordImpl<EntryHistoryRecord> implements Record13<UUID, UUID, Integer, EntryType, String, UUID, String, DvCodedTextRecord, JSONB, Timestamp, java.util.AbstractMap.SimpleEntry<java.time.OffsetDateTime,
                                        java.time.OffsetDateTime>, String, DvCodedTextRecord> {

    private static final long serialVersionUID = 486709942;
    ...
    @Override
    public Row13<UUID, UUID, Integer, EntryType, String, UUID, String, DvCodedTextRecord, JSONB, Timestamp, java.util.AbstractMap.SimpleEntry<java.time.OffsetDateTime,
                                        java.time.OffsetDateTime>, String, DvCodedTextRecord> valuesRow() {
    ...
    @Override
    public EntryHistoryRecord value11(java.util.AbstractMap.SimpleEntry<java.time.OffsetDateTime,
                                        java.time.OffsetDateTime> value) {
        setSysPeriod(value);
        return this;
    }
    ...
    @Override
    public EntryHistoryRecord values(UUID value1, UUID value2, Integer value3, EntryType value4, String value5, UUID value6, String value7, DvCodedTextRecord value8, JSONB value9, Timestamp value10, java.util.AbstractMap.SimpleEntry<java.time.OffsetDateTime,
                                        java.time.OffsetDateTime> value11, String value12, DvCodedTextRecord value13) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public EntryHistoryRecord(UUID id, UUID compositionId, Integer sequence, EntryType itemType, String templateId, UUID templateUuid, String archetypeId, DvCodedTextRecord category, JSONB entry, Timestamp sysTransaction, java.util.AbstractMap.SimpleEntry<java.time.OffsetDateTime,
                                        java.time.OffsetDateTime> sysPeriod, String rmVersion, DvCodedTextRecord name) {
        super(EntryHistory.ENTRY_HISTORY);
