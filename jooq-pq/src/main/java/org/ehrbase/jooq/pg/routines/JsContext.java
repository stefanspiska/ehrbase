...
public class JsContext extends AbstractRoutine<JSON> {

    private static final long serialVersionUID = -1818091181;

    /**
     * The parameter <code>ehr.js_context.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>ehr.js_context._1</code>.
     */
     ...
     */
    public JsContext() {
        super("js_context", Ehr.EHR, org.jooq.impl.SQLDataType.JSON);
