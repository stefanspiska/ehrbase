...
public class StatusRecord extends UpdatableRecordImpl<StatusRecord> implements Record13<UUID, UUID, Boolean, Boolean, UUID, ItemStructure, Timestamp, java.util.AbstractMap.SimpleEntry<java.time.OffsetDateTime,
                                        java.time.OffsetDateTime>, UUID, UUID, UUID, String, DvCodedTextRecord> {

    private static final long serialVersionUID = 1583751518;
    ...
    @Override
    public StatusRecord value8(java.util.AbstractMap.SimpleEntry<java.time.OffsetDateTime,
                                        java.time.OffsetDateTime> value) {
        setSysPeriod(value);
        return this;
    }
    ...
    @Override
    public StatusRecord values(UUID value1, UUID value2, Boolean value3, Boolean value4, UUID value5, ItemStructure value6, Timestamp value7, java.util.AbstractMap.SimpleEntry<java.time.OffsetDateTime,
     ...
     */
    public StatusRecord(UUID id, UUID ehrId, Boolean isQueryable, Boolean isModifiable, UUID party, ItemStructure otherDetails, Timestamp sysTransaction, java.util.AbstractMap.SimpleEntry<java.time.OffsetDateTime,
