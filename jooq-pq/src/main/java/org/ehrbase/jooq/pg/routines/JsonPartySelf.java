...
public class JsonPartySelf extends AbstractRoutine<JSON> {

    private static final long serialVersionUID = 1121249512;

    /**
     * The parameter <code>ehr.json_party_self.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>ehr.json_party_self.ref_type</code>.
     */
    ...
    /**
     * The parameter <code>ehr.json_party_self.objectid_type</code>.
     */
     ...
     */
    public JsonPartySelf() {
        super("json_party_self", Ehr.EHR, org.jooq.impl.SQLDataType.JSON);
