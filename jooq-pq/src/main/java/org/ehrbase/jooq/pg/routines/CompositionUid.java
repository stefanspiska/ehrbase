...
public class CompositionUid extends AbstractRoutine<String> {
    ...
    private static final long serialVersionUID = 755173287;
     ...
     */
    public static final Parameter<UUID> COMPOSITION_UID = Internal.createParameter("composition_uid", org.jooq.impl.SQLDataType.UUID, false, false);
    ...
    public CompositionUid() {
        super("composition_uid", Ehr.EHR, org.jooq.impl.SQLDataType.CLOB);
    ...
    /**
     * Set the <code>composition_uid</code> parameter to the function to be used with a {@link org.jooq.Select} statement
     */
