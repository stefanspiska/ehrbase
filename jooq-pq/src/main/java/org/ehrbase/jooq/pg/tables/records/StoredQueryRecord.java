...
public class StoredQueryRecord extends UpdatableRecordImpl<StoredQueryRecord> implements Record6<String, String, String, String, Timestamp, String> {

    private static final long serialVersionUID = -1967145989;
    ...
    @Override
    public StoredQueryRecord values(String value1, String value2, String value3, String value4, Timestamp value5, String value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public StoredQueryRecord(String reverseDomainName, String semanticId, String semver, String queryText, Timestamp creationDate, String type) {
        super(StoredQuery.STORED_QUERY);

        set(0, reverseDomainName);
        set(1, semanticId);
        set(2, semver);
        set(3, queryText);
        set(4, creationDate);
