...
public class FolderRecord extends UpdatableRecordImpl<FolderRecord> implements Record9<UUID, UUID, String, String, Boolean, ItemStructure, Timestamp, java.util.AbstractMap.SimpleEntry<java.time.OffsetDateTime,
                                        java.time.OffsetDateTime>, UUID> {

    private static final long serialVersionUID = 735617502;
    ...
    @Override
    public FolderRecord value8(java.util.AbstractMap.SimpleEntry<java.time.OffsetDateTime,
                                        java.time.OffsetDateTime> value) {
        setSysPeriod(value);
        return this;
    }
    ...
    @Override
    public FolderRecord values(UUID value1, UUID value2, String value3, String value4, Boolean value5, ItemStructure value6, Timestamp value7, java.util.AbstractMap.SimpleEntry<java.time.OffsetDateTime,
     ...
     */
    public FolderRecord(UUID id, UUID inContribution, String name, String archetypeNodeId, Boolean active, ItemStructure details, Timestamp sysTransaction, java.util.AbstractMap.SimpleEntry<java.time.OffsetDateTime,
