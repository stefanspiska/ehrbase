...
public class JsCanonicalObjectVersionId extends AbstractRoutine<JSON> {
    ...
    private static final long serialVersionUID = 1586451648;

    /**
     * The parameter <code>ehr.js_canonical_object_version_id.RETURN_VALUE</code>.
     */
    ...
    public JsCanonicalObjectVersionId() {
        super("js_canonical_object_version_id", Ehr.EHR, org.jooq.impl.SQLDataType.JSON);
