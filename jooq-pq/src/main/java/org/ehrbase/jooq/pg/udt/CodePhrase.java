...
public class CodePhrase extends UDTImpl<CodePhraseRecord> {
    ...
    private static final long serialVersionUID = 132837984;
     ...
     */
    public static final UDTField<CodePhraseRecord, String> TERMINOLOGY_ID_VALUE = createField(DSL.name("terminology_id_value"), org.jooq.impl.SQLDataType.CLOB, CODE_PHRASE, "");

    /**
     * The attribute <code>ehr.code_phrase.code_string</code>.
     */
    public static final UDTField<CodePhraseRecord, String> CODE_STRING = createField(DSL.name("code_string"), org.jooq.impl.SQLDataType.CLOB, CODE_PHRASE, "");
