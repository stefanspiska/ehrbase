...
public class Heading extends TableImpl<HeadingRecord> {
    ...
    private static final long serialVersionUID = -802693487;
     ...
     */
    public final TableField<HeadingRecord, String> CODE = createField(DSL.name("code"), org.jooq.impl.SQLDataType.VARCHAR(16).nullable(false), this, "");

    /**
     * The column <code>ehr.heading.name</code>.
     */
    public final TableField<HeadingRecord, String> NAME = createField(DSL.name("name"), org.jooq.impl.SQLDataType.CLOB, this, "");

    /**
     * The column <code>ehr.heading.description</code>.
     */
    public final TableField<HeadingRecord, String> DESCRIPTION = createField(DSL.name("description"), org.jooq.impl.SQLDataType.CLOB, this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.HEADING_PKEY);
    }
