...
public class JsAuditDetails extends AbstractRoutine<JSON> {

    private static final long serialVersionUID = 826303938;

    /**
     * The parameter <code>ehr.js_audit_details.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>ehr.js_audit_details._1</code>.
     */
     ...
     */
    public JsAuditDetails() {
        super("js_audit_details", Ehr.EHR, org.jooq.impl.SQLDataType.JSON);
